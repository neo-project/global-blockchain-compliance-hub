...
### Initiative and Trust Activities

Initiative and trust activities need a greater emphasis on safety than the games above. These types of activities are riskier and therefore need careful management. Your judgment as a leader is very important with initiatives. Issues of trust, touching, and the group's ability to maintain attention to safety are important to the selection of these activities.

When it comes to initiatives, there are FOP approved initiatives and then those you and your co-leader may invent. Although creative use of activities is a wonderful addition to a trip, some activities are dangerous and leaders need to use careful judgment. Any activities where participants are tossed in the air, end up wrestling, or are put in situations where it is difficult for a person to protect themselves from a fall are all activities leaders should not present or invite their groups to join. FOP does have a limited amount of initiative and trust activities that are considered appropriate in the industry. Many times your FOPpers will want to do an activity that they did at camp, NOLS, or OB. While we want to encourage the participation of our FOPpers, we also must guard against experimenting with new activities. There is a story of the leaders (from another program) who were told by a participant that they took trust falls from the top of the van at their camp. After dropping two participants the leaders discovered that trust falls from such a height were not safe. FOP does not want to conduct these types of experiments. In general stick to the tried and true, to what we know. If you are going to teach a non-FOP activity, you may need to defend the use of this activity in court. Think about how appropriate the activity is for the group first, the goals, what you hope to accomplish. Think about the general well-being of the participants and do not assume all games are safe, fun and will advance your goals.
    
#### Initiative Policies
1. The instructor will be present during initiatives.
...
Although almost every day of a FOP trip will bring its own challenges, initiatives can provide additional learning experiences. Initiatives introduce challenges within controlled settings and can be debriefed/processed to encourage FOPpers to consciously reflect on their role within a group or how they react under pressure. Some are framed as activities that translate to Harvard life, but most could work this way with tweaking.

##### Fear in a Hat

Each person writes down several fears about freshman year, anonymously, and puts them in a hat; then leaders/the other FOPpers can discuss them.
...
A leader brings a blindfolded person to a tree. The person explores the tree, then is led away (and maybe turned around a few times). The person then tries to find their tree after removing the blindfold.

##### Raccoon Circles

Invite the group to stand in a circle, arms length apart. Pass the rope around the circle so everybody is holding it. When it arrives back to you, tie a knot in it (recommended: square knot, it will hold and won't tighten too much on itself). Now you can ask the group to plant their feet on the ground and try to all lean back at the same time so that they are all being held up by the rope. IF they master that, you can have people lean forward or backward, alternatively or try sitting down and standing up together.

##### Turning Over a New Leaf

Have everyone stand on a personal tarp and turn it over without touching the ground. Keep folding the tarp and ask the group how many folds they think they can do and still turn it over. This can be really frustrating and groups often fail, so keep an eye out for frustration levels. Alternatively have everyone's feet touch the tarp. Fold it and ask the group how many folds they think they can make. Often the group will surpass its predictions as people come up with creative solutions.

##### Vegetarians and Cannibals

Participants must have all objects cross over an imaginary river. There is a boat that can only hold two objects at once. The only other rule is that cannibals (yellow objects) can never out-number vegetarians (red objects) on either side of the river or in the boat.

##### Warp Speed

Have the group stand in a circle. Toss a soft object to one person, saying his name. Continue the tossing until everyone has caught and tossed the object. Have the group repeat this same pattern several times, then ask them to do it faster (see how quickly they can do it). Add more objects for an extra challenge.
